import { Layer, BlendMode, LayerColor } from 'ag-psd'
...
export declare function createEnum<T>(
  prefix: string,
  def: string,
  map: Dict,
): {
...
export declare function offsetForChannel(
  channelId: ChannelID,
  cmyk: boolean,
): number
...
export declare function decodeBitmap(
  input: PixelArray,
  output: PixelArray,
  width: number,
  height: number,
): void
export declare function writeDataRaw(
  data: PixelData,
  offset: number,
  width: number,
  height: number,
): Uint8Array | undefined
export declare function writeDataRLE(
  buffer: Uint8Array,
  { data, width, height }: PixelData,
  offsets: number[],
  large: boolean,
): Uint8Array | undefined
export declare function writeDataZipWithoutPrediction(
  { data, width, height }: PixelData,
  offsets: number[],
): Uint8Array
export declare let createCanvas: (
  width: number,
  height: number,
) => OffscreenCanvas | HTMLCanvasElement
export declare let createCanvasFromData: (
  data: Uint8Array,
) => OffscreenCanvas | HTMLCanvasElement
